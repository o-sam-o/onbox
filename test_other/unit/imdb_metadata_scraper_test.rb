...
class ImdbMetadataScraperTest < Test::Unit::TestCase
  ...
  def test_search_for_imdb_id
    puts "Search 1"
    assert_equal('0146882', ImdbMetadataScraper.search_for_imdb_id('High Fidelity', 2000))
    puts "Search 2"
    assert_equal('0146882', ImdbMetadataScraper.search_for_imdb_id('High Fidelity', nil))
    puts "Search 3"
    assert_equal('0206807', ImdbMetadataScraper.search_for_imdb_id('High Fidelity', 1976))
    puts "Search 4"
    assert_equal('0146882', ImdbMetadataScraper.search_for_imdb_id('High Fidelity limited', 2000))
    
    #Test year format (2009/I)    
    puts "Search 5"
    assert_equal('0362478', ImdbMetadataScraper.search_for_imdb_id('The Box', 2009))
    puts "Search 6"
    assert_equal('0321512', ImdbMetadataScraper.search_for_imdb_id('The Box', 2000))
